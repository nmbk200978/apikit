...
//
//  @Test
//  public void validURlEncodedFormNotRequiredParamsV2() throws MuleRestException {
...
//
//    //mock parameter "must" with default value "true"
...
//    //ExpressionManager expressionManager = new DefaultExpressionManager(mockMuleContext, streamingManager);
//
//    //send mocked mimetype to validator
//    UrlencodedFormV2Validator urlEncodedFormvalidator = new UrlencodedFormV2Validator(mimeType);
//
//    Map<String, String> payload = new HashMap<>();
//    payload.put("must", null);
...
//
//  @Test
//  public void validRequiredURlEncodedFormParamsV2() throws MuleRestException {
//    Map<String, String> payload = new HashMap<>();;
//    payload.put("must", "true");
//
//    MimeTypeImpl mimeType = mock(MimeTypeImpl.class);
//    UrlencodedFormV2Validator urlEncodedFormvalidator = new UrlencodedFormV2Validator(mimeType);
//
//    Map<String, String> validatedParams = urlEncodedFormvalidator.validate(payload);
//
...
//
//  @Test
//  public void skipValidationUrlEncodedFormParamsV1() throws MuleRestException {
//
//    //mock parameter "must" with default value "true"
//    IMimeType mimeType = mock(IMimeType.class);
//    when(mimeType.getType()).thenReturn("application/x-www-form-urlencoded");
